...
const variantStyles = {
  ...
  secondary:
    "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus-visible:ring-gray-300/40 shadow-sm dark:bg-dark-2 dark:text-gray-200 dark:border-dark-3 dark:hover:bg-dark-3",
  danger:
